"""
Django settings for spring_silence_dev_132765 project.
...
ROOT_URLCONF = 'spring_silence_dev_132765.urls'
...
WSGI_APPLICATION = 'spring_silence_dev_132765.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_silence_dev_132765 API",
    "DESCRIPTION": "API documentation for spring_silence_dev_132765 App",
    "VERSION": "v1",
}
